...
import com.ziroom.godeye.filter.DubboFilter;
import com.ziroom.godeye.filter.Tracer;
import com.ziroom.godeye.transfer.disruptor.DisruptorTransfer;
import com.ziroom.godeye.transfer.disruptor.SpanEventHandler;
...
public class TransferEngine {
  ...
  public void start() {
    if (StringUtils.isBlank(url)) {
      ...
      throw new IllegalArgumentException("transfer url not defined");
    }
