...
/** @Description: @Author: by qlb @Date: 2017/2/23 13:32 @Version: 1.0 */
@Setter
@Getter
public class Span implements Serializable {
  ...
  private int subSpanNum;//子span数量
  ...
  public boolean addException(
      String className, String methodName, Throwable ex, Endpoint endpoint) {
